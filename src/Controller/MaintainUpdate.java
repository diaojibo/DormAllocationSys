...
public class MaintainUpdate extends HttpServlet {
	protected void service(HttpServletRequest req, HttpServletResponse resp)
		...
		if (user==null){
			...
			try {
					...
					//String newdorm
					String newdormnum = (String)req.getParameter("dorm");
					String newreason=(String)req.getParameter("reason");
					String newbooktime=(String)req.getParameter("booktime");
...
//					"set date='"+newdate+"',"+"set solve=''";
					String sql="insert into maintain(dorm_id,book_time,reason,date,solve)"
					+" values('"+dormid+"','"+newbooktime+"','"+newreason+"','"+newdate+"','否');";
