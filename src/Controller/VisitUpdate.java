...
public class VisitUpdate extends HttpServlet {
	protected void service(HttpServletRequest req, HttpServletResponse resp)
		...
		if (user==null){
			...
			try {
					...
					String newvisitor=(String)req.getParameter("visitor");
					String newvisitorid=(String)req.getParameter("visitorid");
					String newvisited=(String)req.getParameter("visited");
					String newtime=(String)req.getParameter("time");
					...
					if(!m.find()){
						...
						out.println("<script>location.href='visit.jsp';</script>");
						return;
					}
					...
					String sql="insert into visit(stu_id,date,vid,name,time)"
					+" values('"+stuid+"','"+newdate+"','"+newvisitorid+"','"+newvisitor+"','"+newtime+"');";
					tool.wrong(sql);
